...
require (
	...
	github.com/cockroachdb/cockroachdb-parser v0.0.0-20221108120757-a1ab1810b088
...
require (
	...
	github.com/mailgun/groupcache v1.3.0 // indirect
	github.com/mailgun/groupcache/v2 v2.4.1 // indirect
